...
class CreateWholeAbdomenFemalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('whole_abdomen_females', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('whole_abdomen_females');
    }
}
