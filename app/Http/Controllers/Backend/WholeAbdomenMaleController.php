...
use App\Models\WholeAbdomenMale;
use Illuminate\Support\Facades\DB;
use App\Http\Controllers\Controller;

class WholeAbdomenMaleController extends Controller
{
    /**
    ...
    public function createId($id)
    {
        ...
        $wholeAbdomenMale = WholeAbdomenMale::where('patient_test_id', $id)->first();
        return view('admin.whole_abdomen_male.create', compact('patientTest', 'wholeAbdomenMale'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($r_status==0)
        {
            ...
            try{
                WholeAbdomenMale::where('patient_test_id', $patientTestID)->update($data);
                DB::commit();
    ...
    {
        $wholeAbdomenMale = WholeAbdomenMale::where('patient_test_id',$id)->first();
        return view('admin.whole_abdomen_male.report', compact('wholeAbdomenMale'));
    }
