                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('whole-abdomen-female.store')}}" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    @php
                                        if(isset($wholeAbdomenFemale->kidney)){
                                            $kidney = $wholeAbdomenFemale->kidney;
                                    ...
                                    @php
                                        if(isset($wholeAbdomenFemale->kidney_left)){
                                        $kidney_left = $wholeAbdomenFemale->kidney_left;
                                    ...
                                    @php
                                        if(isset($wholeAbdomenFemale->rk)){
                                        $rk = $wholeAbdomenFemale->rk;
                                        }else{$rk = old('rk');}
                                    @endphp
                                    <div class="form-group col">
                                    ...
                                    @php
                                        if(isset($wholeAbdomenFemale->lk)){
                                        $lk = $wholeAbdomenFemale->lk;
                                        }else{$lk = old('lk');}
                                    @endphp
                                ...
                                <div class="row">
                                    @php
                                        if(isset($wholeAbdomenFemale->interpretation)){
                                            $interpretation = $wholeAbdomenFemale->interpretation;
