                                ...
                                <div class="row">
                                    <div class="form-group form-floating-label col-md-6">
                                        <input id="name" name="name" type="text"
                                            class="form-control input-border-bottom" value="{{$admins->name}}"
                                            required="">
                                        <label for="name" class="placeholder">Name</label>
                                    </div>

                                    <div class="form-group form-floating-label col-md-6">
                                        <select class="form-control input-solid" id="specialist"
                                            name="doctor_specialist" required="" alue="{{$admins->doctor_specialist}}>
                                            <option value="">&nbsp;</option>
                                            @foreach($doctorSpecialists as $doctorSpecialist)
                                            <option value="
                                            {{ $doctorSpecialist->specialist }}">{{ $doctorSpecialist->specialist }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group form-floating-label col-md-4">
                                        <input id="phone" name="phone" type="text" value="{{$admins->phone}}"
                                            class="form-control input-border-bottom" required="">
                                        <label for="phone" class="placeholder">Phone</label>
                                    </div>

                                    <div class="form-group form-floating-label col-md-3">
                                        <input id="age" name="age" type="text" value="{{$admins->age}}"
                                            class="form-control input-border-bottom" required="">
                                    ...
                                    <div class="form-group form-floating-label col-md-6">
                                        <input id="email" name="email" type="email" value="{{$admins->email}}"
                                            class="form-control input-border-bottom" required="">
                                        <label for="email" class="placeholder">Email</label>
                                    </div>

                                    <div class="form-group form-floating-label col-md-6">
                                        <input id="address" name="address" type="text" value="{{$admins->address}}"
                                            class="form-control input-border-bottom" required="">
                                    ...
                                    <div class="form-group form-floating-label col-md-6">
                                        <input id="password" name="password" type="password"
                                            class="form-control input-border-bottom" value="{{$admins->password}}"
                                            required="">
