                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('whole-abdomen-male.store')}}" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    @php
                                        if(isset($wholeAbdomenMale->kidney)){
                                            $kidney = $wholeAbdomenMale->kidney;
                                    ...
                                    @php
                                        if(isset($wholeAbdomenMale->kidney_left)){
                                        $kidney_left = $wholeAbdomenMale->kidney_left;
                                    ...
                                    @php
                                        if(isset($wholeAbdomenMale->rk)){
                                        $rk = $wholeAbdomenMale->rk;
                                        }else{$rk = old('rk');}
                                    @endphp
                                    <div class="form-group col">
                                    ...
                                    @php
                                        if(isset($wholeAbdomenMale->lk)){
                                        $lk = $wholeAbdomenMale->lk;
                                        }else{$lk = old('lk');}
                                    @endphp
                                ...
                                <div class="row">
                                    @php
                                        if(isset($wholeAbdomenMale->interpretation)){
                                            $interpretation = $wholeAbdomenMale->interpretation;
